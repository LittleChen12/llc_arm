...
float Motor_relay_position[6] = {165.3f,80.0f,-53.2f,3.07f,12.71f,55.8f};//存放电机初始位置

float test[6]={-0.448716222*50.0f + 165.3f,-0.449609607*50.0f + 80.0f,-0.450502543*50.0f - 53.2f,-0.4513950*4.0f + 3.07f,-0.4522870*4.0f + 12.71f,-0.4531786*30.0f + 55.8f};//写入电机角度
